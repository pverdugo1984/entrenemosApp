...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-AP6QK65S.js").then((m) => m.LoginComponent)
  },
  // Rutas de usuario (requieren autenticación)
  {
    path: "home",
    loadComponent: () => import("./chunk-SRA63BHK.js").then((m) => m.Home),
    canActivate: [authGuard]
  },
  {
    path: "progreso",
    loadComponent: () => import("./chunk-FOJIBO4O.js").then((m) => m.Progreso),
    canActivate: [authGuard]
  },
  {
    path: "comunidad",
    loadComponent: () => import("./chunk-KL3KI6WR.js").then((m) => m.Comunidad),
    canActivate: [authGuard]
  },
  {
    path: "rutina",
    loadComponent: () => import("./chunk-4ZEDB7UO.js").then((m) => m.Programas),
    canActivate: [authGuard]
  },
  {
    path: "rutina/:id",
    loadComponent: () => import("./chunk-T2ZEYQSZ.js").then((m) => m.DetallePrograma),
    canActivate: [authGuard]
  },
  {
    path: "perfil",
    loadComponent: () => import("./chunk-HXR5HAUD.js").then((m) => m.Perfil),
    canActivate: [authGuard]
  },
  {
    path: "tienda",
    loadComponent: () => import("./chunk-SFNS5I42.js").then((m) => m.Tienda),
    canActivate: [authGuard]
  },
  // Rutas de administración (requieren rol ADMIN)
  {
    path: "admin",
    loadChildren: () => import("./chunk-7MIXOLIB.js").then((m) => m.adminRoutes),
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", imports: [RouterOutlet], template: "<router-outlet />", styles: ["/* src/app.css */\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(App, { className: "App", filePath: "src/app.ts", lineNumber: 10 });
})();
