...
var IndexedDbService = class _IndexedDbService extends import_wrapper_default {
  messages;
  constructor() {
    super("ChatDatabase");
  ...
  addMessage(message) {
    return __async(this, null, function* () {
      return yield this.messages.add(message);
    });
  }
  getAllMessages() {
    return __async(this, null, function* () {
      return yield this.messages.toArray();
    });
  }
  clearMessages() {
    return __async(this, null, function* () {
      return yield this.messages.clear();
    });
  }
...
var WebsocketService = class _WebsocketService {
  db;
  socket$;
  mensajesSubject = new Subject();
  mensajes$ = this.mensajesSubject.asObservable();
  constructor(db) {
    this.db = db;
    const wsUrl = API_BASE_URL.replace("http://", "ws://").replace("https://", "wss://").replace("/api", "/ws");
    this.socket$ = webSocket(wsUrl);
    this.socket$.subscribe({
      next: (msg) => __async(this, null, function* () {
        const allMsgs = yield this.db.getAllMessages();
        const existe = allMsgs.find((m) => m.contenido === msg.contenido && m.fecha === msg.fecha);
        if (!existe) {
          this.mensajesSubject.next(msg);
          yield this.db.addMessage(msg);
        }
      }),
  ...
  static \u0275fac = function WebsocketService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _WebsocketService)(\u0275\u0275inject(IndexedDbService));
  };
...
// src/app/features/chat/components/chat-window.component.ts
var _forTrack0 = ($index, $item) => $item.fecha;
function ChatWindowComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 7)(2, "div", 8)(3, "small");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "small", 9);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", m_r1.tipo === "ADMIN" ? "admin" : m_r1.tipo === "ENTRENADOR" ? "entrenador" : "user");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(m_r1.usuario.nombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 4, m_r1.fecha, "HH:mm"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(m_r1.contenido);
  }
}
var ChatWindowComponent = class _ChatWindowComponent {
  ...
  messageSubscription;
  usuarioActual;
  constructor(webSocketService, db, authService) {
  ...
  ngOnInit() {
    ...
    const tipo = rol === "ADMIN" ? "ADMIN" : rol === "ENTRENADOR" ? "ENTRENADOR" : "USUARIO";
    this.usuarioActual = { nombre, tipo };
    this.db.getAllMessages().then((msgs) => this.messages.push(...msgs));
    this.messageSubscription = this.webSocketService.mensajes$.subscribe((msg) => this.messages.push(msg));
  }
  sendMessage() {
  ...
  static \u0275fac = function ChatWindowComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ChatWindowComponent)(\u0275\u0275directiveInject(WebsocketService), \u0275\u0275directiveInject(IndexedDbService), \u0275\u0275directiveInject(AuthService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChatWindowComponent, selectors: [["app-chat-window"]], decls: 11, vars: 2, consts: [[1, "chat-wrap"], [1, "chat-header"], [1, "chat-messages"], [1, "message", 3, "ngClass"], [1, "chat-input"], ["type", "text", "placeholder", "Escribe un mensaje...", 3, "ngModelChange", "keyup.enter", "ngModel"], [3, "click", "disabled"], [1, "bubble"], [1, "meta"], [1, "fecha"], [1, "text"]], template: function ChatWindowComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "strong");
      \u0275\u0275text(3, "Comunidad");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(4, "div", 2);
      \u0275\u0275repeaterCreate(5, ChatWindowComponent_For_6_Template, 10, 7, "div", 3, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "div", 4)(8, "input", 5);
      \u0275\u0275twoWayListener("ngModelChange", function ChatWindowComponent_Template_input_ngModelChange_8_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.messageInput, $event) || (ctx.messageInput = $event);
        return $event;
      });
      \u0275\u0275listener("keyup.enter", function ChatWindowComponent_Template_input_keyup_enter_8_listener() {
        return ctx.sendMessage();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "button", 6);
      \u0275\u0275listener("click", function ChatWindowComponent_Template_button_click_9_listener() {
        return ctx.sendMessage();
      });
      \u0275\u0275text(10, "Enviar");
      \u0275\u0275elementEnd()()();
...
</div>`, styles: ["/* src/app/features/chat/components/chat-window.component.css */\n.chat-wrap {\n  width: 100%;\n  max-width: 640px;\n  margin: 0 auto;\n  border: 1px solid #ddd;\n  border-radius: 8px;\n  display: flex;\n  flex-direction: column;\n  background: #fff;\n}\n.chat-header {\n  padding: 10px 14px;\n  border-bottom: 1px solid #eee;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.status {\n  font-size: 12px;\n  color: #999;\n}\n.status.online {\n  color: green;\n}\n.chat-messages {\n  padding: 12px;\n  height: 320px;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  background: #f6f6f6;\n}\n.message {\n  display: flex;\n}\n.message.user {\n  justify-content: flex-end;\n}\n.message.admin {\n  justify-content: flex-start;\n}\n.bubble {\n  max-width: 75%;\n  padding: 8px 12px;\n  border-radius: 12px;\n  background: #dcf8c6;\n  box-shadow: 0 1px 0 rgba(0, 0, 0, 0.05);\n}\n.message.admin .bubble {\n  background: #fff;\n  border: 1px solid #e5e5e5;\n}\n.meta {\n  display: flex;\n  justify-content: space-between;\n  gap: 8px;\n  font-size: 11px;\n  color: #666;\n  margin-bottom: 4px;\n}\n.text {\n  white-space: pre-wrap;\n  word-break: break-word;\n}\n.chat-input {\n  padding: 10px;\n  display: flex;\n  gap: 8px;\n  border-top: 1px solid #eee;\n}\n.chat-input input {\n  flex: 1;\n  padding: 8px 10px;\n  border: 1px solid #ddd;\n  border-radius: 6px;\n}\n.chat-input button {\n  padding: 8px 14px;\n  border-radius: 6px;\n  background: #29a;\n  color: #fff;\n  border: none;\n  cursor: pointer;\n}\n.chat-input button:disabled {\n  opacity: 0.6;\n  cursor: default;\n}\n/*# sourceMappingURL=chat-window.component.css.map */\n"] }]
  }], () => [{ type: WebsocketService }, { type: IndexedDbService }, { type: AuthService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChatWindowComponent, { className: "ChatWindowComponent", filePath: "src/app/features/chat/components/chat-window.component.ts", lineNumber: 19 });
})();
...
dexie/dist/dexie.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-5XQCRHSE.js.map
